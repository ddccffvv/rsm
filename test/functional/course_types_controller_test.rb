...
class CourseTypesControllerTest < ActionController::TestCase
  ...
  test "should create course_type" do
    assert_difference('CourseType.count') do
      post :create, :course_type => { :hourly_rate => @course_type.hourly_rate, :min_minutes => @course_type.min_minutes, :name => @course_type.name }
    end
  ...
  test "should update course_type" do
    put :update, :id => @course_type, :course_type => { :hourly_rate => @course_type.hourly_rate, :min_minutes => @course_type.min_minutes, :name => @course_type.name }
    assert_redirected_to course_type_path(assigns(:course_type))
  end
